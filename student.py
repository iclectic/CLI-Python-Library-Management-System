...
class Student:
    def __init__(self):
        ...
        self.chonn = sqlite3.connect('studentlogin.db')
    ...
    def login(self):
        while True:
            ...
            student_access_code = input("Enter your code: ")
            self.ch.execute("SELECT * FROM studentlogin WHERE student_access_code = ? AND student_id = ? ", (student_access_code, student_id))
